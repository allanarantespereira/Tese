...
\def\tesetitle{Mapeamento multisensorial de áreas queiamdas}
\def\tesetitleeng{Multi-sensor mapping of burned areas}
\def\tesetitlecap{\expandafter\MakeUppercase\expandafter{\tesetitle}}

%% autor e abreviações
\def\teseauthor{Allan Arantes Pereira}
\def\teseauthorcap{\expandafter\MakeUppercase\expandafter{\teseauthor}}
\def\teseauthorrev{Pereira, Allan Arantes}
\def\teseauthorcrv{PEREIRA, Allan Arantes}

%% ano
\def\teseyear{2017}

%% orientador
\def\teseorientador{Luis Marcelo Carvalho Tavares}
